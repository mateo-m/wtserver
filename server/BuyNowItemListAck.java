 ...
 * @author MSI
 */
public class BuyNowItemListAck extends ServerMsg {
    private final short msgId = ServerMsg.CS_IN_BUYNOW_ITEMLIST_ACK;
    
    public BuyNowItemListAck()
    {
        size = 24;
    ...
    public byte [] getData(short seqNum)
    {
        ...
        addByte(checksum);
        addByte((byte)0);
        addShort((short) 10038);
        addShort((short) 10087);
