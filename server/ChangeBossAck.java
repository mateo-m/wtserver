 ...
 * @author MSI
 */
public class ChangeBossAck extends ServerMsg {
    private final short msgId = ServerMsg.CS_FD_CHANGEBOSS_ACK;
    byte slot;
    
    public ChangeBossAck(byte slot)
    {
        size = 24;
